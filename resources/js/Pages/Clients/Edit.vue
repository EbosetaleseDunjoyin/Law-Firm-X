...
const form = useForm({
    ...
    primary_legal_counsel: props.client.primary_legal_counsel,
    date_of_birth: props.client.date_of_birth,
    date_of_profiling: props.client.date_of_profiling,
    profile_image: props.profile_image,
    case_details: props.client.case_details,
});



function updateClient(){
    router.post(`/client/${props.client.id}/update`,{
        _method: 'put',
        first_name: form.first_name,
        last_name: form.last_name,
        email: form.email,
        primary_legal_counsel: form.primary_legal_counsel,
        date_of_birth: form.date_of_birth,
        date_of_profiling: form.date_of_profiling,
...
<template>
    <div class="">
        ...
        <Head title="Update Client | Law Firm X" />
            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div class="bg-white dark:bg-slate-900 overflow-hidden shadow-sm sm:rounded-lg p-5">
                        ...
                        <h1 class="text-3xl text-center font-semibold">Client: {{ form.first_name }}&nbsp; {{ form.last_name }}</h1>
    
                        <div class=" lg:w-7/12 mx-auto my-5 ">
                            <div class="flex justify-center">
                                <img :src="form.profile_image" class="h-auto w-28 my-5" alt="">
                            </div>
                            <form class="" @submit.prevent="updateClient()">
                                ...
                                <button v-else type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
                            </form>
                        </div>
